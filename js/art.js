...
function (Kinetic) {
    ...
    art.fighter = function (group, radius, postScale) {
            group.setScale(radius/25, radius/25);
            //this.preScale = radius/25, radius/25;
            
            group.add(new Kinetic.Path({
                data: 'M3.917-2.864l20.98,21.208c0,0-7.397,0.823-9.331,0s-4.761-4.253-4.761-4.253',
                fill: '#D71F27',
                stroke: '#000000',
            ...
            group.add(new Kinetic.Path({
                data: 'M-10.805,14.091c0,0-2.827,3.43-4.761,4.253s-9.331,0-9.331,0l20.98-21.208',
                fill: '#D71F27',
                stroke: '#000000',
                strokeWidth: 1 * postScale
            }));
